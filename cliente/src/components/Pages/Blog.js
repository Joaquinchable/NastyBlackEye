...
import PageTop from '../utlis/page_top';
...
class Blog extends Component {
  render() {
      ...
      <div>
        ...
        <section className="section-body">
          ...
          <div className="section-container">
            ...
            <div className="container-encabezado-blog">

              <div className=" titulo-blog"><h1>CiNeMatoGraFia</h1></div>

              <div className="container-imagen-blog">
    ...
    Sección 1.10.32 de "de Finibus Bonorum et Malorum", escrito por Cicero en el 45
    antes de Cristo
